...
def billing_window():
                ...
                if cust_mob_no_found==False:
                    with open('C://ASK-BILLING-S-W//AUTO_FILL_CUST_DETAILS.csv','a',newline='') as cust_detail_file:
                        if cust_name_entry.get()=='' or cust_name_entry.get()=='   customer-name':
                            ...
                            messagebox.showinfo('Customer Details added successfully','Please proceed further...')
    ...
    search_cust_details.place(x=1218,y=10,width=100,height=49)
    ...
    def update_quantity():
        ...
        new_quantity=simpledialog.askinteger('CHANGE ITEM QUANTITY: ','Enter the new quantity: ')
        ...
        def build_bill_data_and_save():
            ...
            def generate_bill():        
                try:
                    ...
                    err='Error occured while generating bill: \n'+str(e)
                    messagebox.showerror('ERROR !! ( Code - 103 )',err)
            search_customer()
            total()
        ...
        def send_mail():
            ...
            Team ASK BILLING S/W</h3>'''
                ...
                try:
                    ...
                    err='Error occured while sending mail: \n'+str(e)
                    messagebox.showerror('ERROR !! ( Code - 103 )',err)
    ...
    def reset_numbering():
        new_numbering=simpledialog.askstring('RESET BILL NUMBERING','Enter the no. to start bill numbering from: ')
    ...
    menubar.add_cascade(label='ITEM-MANAGEMENT WINDOW',command=add_del_items)
...
SYSTEM REQUIREMENTS:
  1. Windows 7/10 64-bit
  2. 1366x768 SCREEN RESOLUTION''')
